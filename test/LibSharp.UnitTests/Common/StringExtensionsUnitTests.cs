...
public class StringExtensionsUnitTests
{
    ...
    public void TryConvertToEnum_HttpStatusCode()
    {
        ...
        Assert.IsTrue("Continue".TryConvertToEnum<HttpStatusCode>(out HttpStatusCode result));
    ...
    public void TryConvertToEnum_StringComparison()
    {
        ...
        Assert.IsTrue("CurrentCulture".TryConvertToEnum<StringComparison>(out StringComparison result));
