...
namespace LibSharp.UnitTests.Collections
{
    ...
    public class MinPriorityQueueUnitTests
    {
        ...
        {
            // Act
            MinPriorityQueue<int> queue = new MinPriorityQueue<int>(new[] { 2, 1, 3 });
        ...
        {
            // Act
            _ = Assert.ThrowsExactly<ArgumentException>(() => new MinPriorityQueue<object>(new[] { new object(), new object(), new object() }));
        }
