...
public class MaxPriorityQueueUnitTests
{
    ...
    {
        // Act
        MaxPriorityQueue<int> queue = new MaxPriorityQueue<int> { 2, 1, 3 };
    ...
    {
        // Arrange
        IPriorityQueue<int> queue = new MaxPriorityQueue<int>();
    ...
    {
        // Arrange
        IPriorityQueue<int> queue = new MaxPriorityQueue<int> { 4, 1, 3 };
    ...
    [TestMethod]
    public void TryDequeue_NonEmptyQueue_ReturnsTrueAndRemovesLargestItem()
    {
        // Arrange
        IPriorityQueue<int> queue = new MaxPriorityQueue<int> { 4, 1, 3 };
    ...
    {
        // Arrange
        MaxPriorityQueue<int> queue = new MaxPriorityQueue<int> { 4, 2 };
    ...
    {
        // Arrange
        MaxPriorityQueue<int> queue = new MaxPriorityQueue<int> { 1, 2, 1, 0, 3 };
