...
- 3.0.0: Added AsyncLock, DebouncedAction, ThrottledAction, ConcurrentHashSet, Result classes. Renamed Box to Optional, allowed null values. ProactiveAsyncCache constructor now accepts ProactiveAsyncCacheOptions with more controls. Regex extensions return a bool indicating whether the regex matching timed out.
