...
- 3.0.0: Added AsyncLock. Renamed Box to Optional, allowed null values. ProactiveAsyncCache constructor now accepts ProactiveAsyncCacheOptions with more controls. Regex extensions return a bool indicating whether the regex matching timed out.
