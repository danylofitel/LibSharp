...
- 5.0.0
  ...
  - `Common`
    ...
    - `StringExtensions.Reverse` now appends each grapheme cluster into a pre-sized `StringBuilder` instead of allocating one string per cluster and concatenating them
